document.addEventListener("DOMContentLoaded", () => {
    ...
    responseForm.addEventListener("submit", function (event) {
        ...
        const answer = toggleCheckbox.checked
            ? Array.from(checkboxAnswers).filter(cb => cb.checked).map(cb => cb.value)
        ...
        fetch("https://script.google.com/macros/s/AKfycbxQQzw2QJIXRPLlSuHBU_SbcpJmFlIvKvB-lxWO46ppLQYVx4eV3m4B4LZFTPTYPNux/exec", {
            method: "POST",
            body: formData,
        })
